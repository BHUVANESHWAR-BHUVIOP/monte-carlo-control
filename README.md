...
def probability_success(env, pi, goal_state, n_episodes=50000, max_steps=200, seed=123):
    random.seed(seed)
    np.random.seed(seed)
    env.seed(seed)
    results = []
...
def mean_return(env, pi, n_episodes=50000, max_steps=200, seed=123):
    random.seed(seed)
    np.random.seed(seed)
    env.seed(seed)
    results = []
...
### Policy
![pi](https://github.com/BHUVANESHWAR-BHUVIOP/monte-carlo-control/assets/94155099/2b52af28-8d8a-4b06-a630-6a5ec2e78ea5)

### Success Percentage of Policy
![reach](https://github.com/BHUVANESHWAR-BHUVIOP/monte-carlo-control/assets/94155099/45c361e7-cbfc-4828-988b-e7075f57d2c9)
